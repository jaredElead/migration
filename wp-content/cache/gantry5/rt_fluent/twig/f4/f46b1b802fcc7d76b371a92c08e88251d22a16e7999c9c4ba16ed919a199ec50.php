...
class __TwigTemplate_67dacf21a0a47d8629db918c95626a3efe354a2ffbc0660970742d68f7935448 extends Twig_Template
{
...
($context["image"] ?? null)) {
        ...
        ";
            ...
            // line 17
            echo "            ";
            echo (($this->getAttribute(($context["particle"] ?? null), "text", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute(($context["particle"] ?? null), "text", array()), "Logo")) : ("Logo"));
            echo "
        ";
        }
        // line 19
    ...
    {
        return new Twig_Source("", "@particles/logo.html.twig", "/var/www/vhosts/rzn8.com/elead.rzn8.com/wp-content/themes/rt_fluent/particles/logo.html.twig");
    }
}
